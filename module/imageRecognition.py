...
#         imagePath = f"testpicwithzz/{i}.png"
#         img = cv2.imread(imagePath)
#         img = change_image(img)
#         scantext = pytesseract.image_to_string(img, lang='chi_tra+eng')
#         # print(scantext)
#         percent = (difflib.SequenceMatcher(
#             None, scantext, pagetext[i]).quick_ratio())
#         sum += percent
#         print(f"page{i}: {percent}")

#     # print("辨識度: "+str(sum / len(pagetext)))
#     print("預處理圖片後辨識度: "+str(sum / len(pagetext)))
